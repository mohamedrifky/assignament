        ...
        <div class="card m-t-35" style="min-height:400px">
          <div class="card-block p-t-10">
           @if(session()->has('mymessage'))
            ...
            <div class="">
              <div class="col-lg-12">
              <form method="post" action="{{route('create_parents_p')}}" id="form" name="post">
                {{ csrf_field() }}
                <div class="row">
              ...
              <div class="col-lg-12 m-t-20">
               <table class="table table-striped table-bordered table-hover m-t-20" id="sample_6">
                ...
                <tr>
                <td>{{$parent->name}}</td>
                 <td>@if($parent->type=="m") Male @else Female @endif</td>
                  <td>{{$parent->dob}}</td>
                   <td><a href="{{route('edit_parent',['id'=>$parent->id])}}" class="btn btn-info"><i class="fa fa-pencil"></i></a></td>
                    <td><a href="{{route('delete_parent',['id'=>$parent->id])}}" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                </tr>
                @endforeach
