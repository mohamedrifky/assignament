        ...
        <div class="card m-t-35" style="min-height:400px">
          <div class="card-block p-t-10">
           @if(session()->has('mymessage'))
            ...
            <div class="">
              <div class="col-lg-12">
              <form method="post" action="{{route('edit_course_p',['id'=>$course->id])}}" id="form" name="post">
                {{ csrf_field() }}
                <div class="row">
                
                  <div class="col-lg-4 ">
                    <label><h5>Course Name</h5></label>
                   <input type="text" class="form-control" id="c_name" name="c_name" required value="{{$course->name}}">
